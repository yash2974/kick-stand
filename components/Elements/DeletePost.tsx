...
const DeletePost = ({ visible, onClose, post_id, loading, setLoading, user_id}: DeletePostProps) => {
    ...
    >
      <View style={styles.container}>
        <View style={styles.modalView}>
          <Text style={styles.modalText}>Do you want to delete the forum?</Text>

          <View style={styles.buttonRow}>
            <TouchableOpacity onPress={()=>{deletePost()}} style={[styles.buttonCancel, {backgroundColor: loading ? "#9E9E9E" : "#C62828"}]} disabled={loading}>
